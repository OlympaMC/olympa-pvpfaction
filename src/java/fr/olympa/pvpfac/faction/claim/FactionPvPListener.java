...
//		if (!(entityVictim instanceof final Player victim)) return;
		...
		final FactionPlayer victimFactionPlayer = AccountProviderAPI.getter().get(victim.getUniqueId());
		...
		final FactionPlayer attackerFactionPlayer = AccountProviderAPI.getter().get(attacker.getUniqueId());
